...
import com.atmecs.assessment.pages.SwagLabsFilter;
import com.atmecs.assessment.pages.SwagLabsLoginPage;
import com.atmecs.assessment.utils.ExcelDataProvider;

public class SwagLabsFiltersTest extends TestBase {

	@Test
	public void testSwagLabsFilters() {
		...
		if (loginSuccess == true) {
			...
			SwagLabsFilter swagLabsFilterPage = new SwagLabsFilter();
			swagLabsFilterPage.testFilterPage(browser.getDriver());
